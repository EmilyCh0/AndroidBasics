...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding  {
    ...
    protected void executeBindings() {
        ...
        java.lang.String taxAndroidStringTaxStringValueOfViewModelTax = null;
        ...
        java.lang.String stringValueOfViewModelTax = null;
        java.lang.String totalAndroidStringTotalStringValueOfViewModelTotal = null;
        java.lang.String viewModelTotalGetValue = null;
        com.example.lunchtray.model.OrderViewModel viewModel = mViewModel;
        androidx.lifecycle.LiveData<java.lang.String> viewModelTax = null;
        java.lang.String stringValueOfViewModelTotal = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x188L) != 0) {
                    ...
                    // read String.valueOf(viewModel.total.getValue())
                    stringValueOfViewModelTotal = java.lang.String.valueOf(viewModelTotalGetValue);


                    // read @android:string/total
                    totalAndroidStringTotalStringValueOfViewModelTotal = total.getResources().getString(R.string.total, stringValueOfViewModelTotal);
            }
            ...
            if ((dirtyFlags & 0x1a0L) != 0) {
                    ...
                    // read String.valueOf(viewModel.tax.getValue())
                    stringValueOfViewModelTax = java.lang.String.valueOf(viewModelTaxGetValue);


                    // read @android:string/tax
                    taxAndroidStringTaxStringValueOfViewModelTax = tax.getResources().getString(R.string.tax, stringValueOfViewModelTax);
            }
        }
        // batch finished
        if ((dirtyFlags & 0x181L) != 0) {
        ...
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tax, taxAndroidStringTaxStringValueOfViewModelTax);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.total, totalAndroidStringTotalStringValueOfViewModelTotal);
        }
    }
